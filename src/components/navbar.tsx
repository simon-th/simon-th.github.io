...
function MobileMenuButton(props: MobileMenuButtonProps) {
  ...
  return (
    <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
      <button
        type="button"
        className="inline-flex items-center justify-center p-2 rounded-md text-slate-400 hover:text-white hover:bg-highlight focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
